...
DEVICE="auto"
OUTPUT_DIR="outputs"
EXPERIMENT_NAME="main_vit_basic"
DRY_RUN=""
AMP="--amp"
RESUME=""
SAVE=""
...
NUM_WORKERS=4
VAL_RATIO=0.1
IMAGE_SIZE=""                 # empty means CIFAR-10 default 32
DOWNLOAD="--download"
...
VIT_HEADS=8
VIT_MLP_RATIO=4.0
QKV_BIAS="--qkv-bias"         # use "--no-qkv-bias" to disable
CLS_TOKEN="--cls-token"       # use "--no-cls-token" to disable
